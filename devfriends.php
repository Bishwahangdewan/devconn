...
<div class="container pt-20">
	<div class="body-container">
		<p class="fw-9 fs-30">Developers you follow : <?php echo $friends; ?> </p>
		<p class="fw-3 fs-14 pt-10">List of all the developers that you follow.</p>
				...
				<div class="content pl-20 pt-10">
					<div class="row">
						...
						<div class="col s5 flex">
							...
							<a href="" class="btn-small amber darken-2 ml-10"><i class="fas fa-envelope white-text"></i> Message</a>
						</div>
					</div>
